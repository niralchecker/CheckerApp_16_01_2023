 ...
 **/
public class CrashReportDialog extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boolean forceCancel = getIntent().getBooleanExtra(
		...
		mDialog.show();
		//
		// alertnetwork = new Dialog(CrashReportDialog.this);
		// // addPhoneDialog.setCanceledOnTouchOutside(false);
		// alertnetwork.requestWindowFeature(Window.FEATURE_NO_TITLE);
		// alertnetwork.setContentView(R.layout.dialog_app_crashed);
		// alertnetwork.getWindow().setBackgroundDrawable(new ColorDrawable(0));
		...
		// Log.i("wklee", "Network alert cancel");
		// alertnetwork.dismiss();
		// finish();
		// }
		// });
		// ImageView btnNetworkOK = (ImageView) alertnetwork
		// .findViewById(R.id.network_alert_OK);
		// btnNetworkOK.setOnClickListener(new OnClickListener() {
		// @Override
		// public void onClick(View v) {
		// alertnetwork.dismiss();
		// Intent i = new Intent(CrashReportDialog.this,
		// MainActivity.class);
		// i.putExtra("isCrash", true);
		// startActivity(i);
		// finish();
		// }
		// });
	...
	private View buildCustomView(Bundle savedInstanceState) {
		...
		if (emailPromptId != 0) {
			...
			userEmail.setInputType(InputType.TYPE_CLASS_TEXT
					| InputType.TYPE_TEXT_VARIATION_EMAIL_ADDRESS);

			prefs = getSharedPreferences(ACRA.getConfig()
					.sharedPreferencesName(), ACRA.getConfig()
	...
	public void onClick(DialogInterface dialog, int which) {
		if (which == DialogInterface.BUTTON_POSITIVE) {
			sendCrash();
//			Intent i = new Intent(CrashReportDialog.this, MainActivity.class);
//			i.putExtra("isCrash", true);
//			startActivity(i);
	...
	private void sendCrash() {
		...
		final String comment = userComment != null ? userComment.getText()
				.toString() : "";
